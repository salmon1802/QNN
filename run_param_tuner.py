...
# distributed undper the License is distributed on an "AS IS" BASIS,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/QNN_tuner_config_Criteo.yaml',
    ...
    parser.add_argument('--gpu', nargs='+', default=[2, 3],
