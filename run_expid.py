...
if __name__ == '__main__':
    ...
    parser.add_argument('--expid', type=str, default='QNN_Criteo', help='The experiment id to run.')
    ...
    if test_gen:
      ...
      # model.visualize_loss_landscape_3d(test_gen, dir='/home/lhh/code/model_zoo/QNN/plot/landscape.pdf')
      # model.device = torch.device("cpu")
      # model.model_to_device()
      # avg_inference_time_per_sample = model.latency(test_gen)
