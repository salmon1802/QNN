...
class QNN_T26_DeepFM(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="QNN_T26_DeepFM",
                 gpu=-1,
                 learning_rate=1e-3,
                 embedding_dim=16,
                 num_layers=3,
                 ...
                 **kwargs):
        super(QNN_T26_DeepFM, self).__init__(feature_map,
                                      model_id=model_id,
                                      gpu=gpu,
    ...
    def forward(self, inputs):
        ...
        y_pred = self.qnn(feature_emb.flatten(start_dim=1)) + self.fm(X, feature_emb) * 0.5
